...
//                     <button type="button" className=" font-semibold  rounded dark:border-gray-800 dark:text-gray-800">

//                 {status}</button>
//                     </div>
                 
//                   <img src={image} alt="" className="object-cover object-center w-full rounded-t-md h-72 dark:bg-gray-500" data-aos="zoom-in"
